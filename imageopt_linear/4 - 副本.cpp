...
const uint DESIRE_VERTICES_NUM = 300;
...
)
{
    ...
    for (auto& triPtr : tmpTriList) {
        ...
        //    cv::imshow("[energyRecal] tmp2", tmp2);
        //    wt(0);
        //}
    ...
    for (auto& triPtr : tmpTriList) {
        for (auto& coordinatePair : triPtr->pixelsList)
        {
            ...
            for (uint channelId = 0; channelId < 3; channelId++) {
                ...
                energySum += std::pow((hx - interpolationResult[channelId] / 256.0), 2);
            }
        }
    }
...
int main2()
{
    ...
    String imgPath = "D:\\图\\Snipaste_2023-03-29_22-54-33.jpg"; // lu
